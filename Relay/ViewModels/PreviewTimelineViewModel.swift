...
final class PreviewTimelineViewModel: TimelineViewModelProtocol {
    ...
    nonisolated static let sampleMessages: [TimelineMessage] = [
        ...
        .init(id: "2", senderID: "@bob:matrix.org", senderDisplayName: "Bob",
              ...
              reactions: [
                .init(key: "👍", count: 1, senderIDs: ["@alice:matrix.org"],
        ...
        .init(id: "3", senderID: "@me:matrix.org",
              ...
              reactions: [
                .init(key: "🎉", count: 3,
                      ...
                      highlightedByCurrentUser: false),
                .init(key: "🚀", count: 2,
                      senderIDs: ["@alice:matrix.org", "@me:matrix.org"],
        ...
        .init(id: "4", senderID: "@alice:matrix.org", senderDisplayName: "Alice",
              ...
              reactions: [
                .init(key: "👍", count: 2,
                      senderIDs: ["@me:matrix.org", "@bob:matrix.org"],
                      highlightedByCurrentUser: true),
                .init(key: "❤️", count: 1,
                      senderIDs: ["@charlie:matrix.org"],
                      highlightedByCurrentUser: false),
              ],
              replyDetail: .init(
        ...
        .init(id: "8", senderID: "@charlie:matrix.org", senderDisplayName: "Charlie",
              ...
              reactions: [
                .init(key: "👋", count: 3,
                      senderIDs: ["@alice:matrix.org", "@bob:matrix.org", "@me:matrix.org"],
                      highlightedByCurrentUser: true),
              ]),
        ...
        .init(id: "10", senderID: "@alice:matrix.org", senderDisplayName: "Alice",
              ...
              reactions: [
                ...
                .init(key: "😍", count: 1,
                      ...
                      highlightedByCurrentUser: false),
                .init(key: "👍", count: 2,
                      senderIDs: ["@bob:matrix.org", "@charlie:matrix.org"],
                      highlightedByCurrentUser: false),
              ]),
