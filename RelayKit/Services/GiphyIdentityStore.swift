...
public final class GiphyIdentityStore: @unchecked Sendable {
    public static let shared = GiphyIdentityStore()
    ...
    nonisolated public var currentID: String? {
    ...
    /// stored identifier.
    nonisolated public func bootstrap(apiKey: String) async {
