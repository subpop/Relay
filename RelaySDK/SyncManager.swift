...
/// It reports the current sync state using an `AsyncSDKListener` for reactive state updates.
...
final class SyncManager {
    ...
    /// via `AsyncSDKListener`, and waits for the first `.running` state before returning.
    ///
